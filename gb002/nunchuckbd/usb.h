...
extern BYTE USB_protocol;
extern BYTE USB_idle_rate;
extern BYTE USB_LED_states;
extern BYTE EP1_IN_buffer[];
extern BYTE EP2_IN_buffer[];

extern BYTE __attribute__ ((space(auto_psv))) Device[];
extern BYTE __attribute__ ((space(auto_psv))) Configuration1[];
extern BYTE __attribute__ ((space(auto_psv))) Report1[];
extern BYTE __attribute__ ((space(auto_psv))) Report2[];
...
extern void ClassRequestsIn(void);
extern void ClassRequestsOut(void);
